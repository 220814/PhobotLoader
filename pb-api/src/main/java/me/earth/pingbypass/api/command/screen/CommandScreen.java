...
public class CommandScreen extends Screen {
    ...
    protected void init() {
        ...
        input = new EditBox(minecraft.font, 2, height - 12, width - 4, 12, Component.literal("CommandsChat")) {
            @Override
    ...
    public void render(@NotNull GuiGraphics graphics, int x, int y, float delta) {
        ...
        // SỬA LỖI TẠI ĐÂY: Thêm tham số 'true' (focused) cho Minecraft 1.21.1
        chatComponent.render(graphics, tickCount, x, y, true);
