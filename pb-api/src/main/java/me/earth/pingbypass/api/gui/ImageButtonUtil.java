...
public class ImageButtonUtil {
    private static final ResourceLocation ICON_BUTTON = ResourceLocation.fromNamespaceAndPath("pingbypass", "icon/icon_button");
    private static final ResourceLocation ICON_BUTTON_FOCUSED = ResourceLocation.fromNamespaceAndPath("pingbypass", "icon/icon_button_focused");
